Param (
    ...
    [Parameter(Mandatory=$false)]
    [String]
    $32BitDownloadLocation = "http://winampplugins.co.uk/curl/curl_7_50_0_openssl_nghttp2_x86.7z",

    [Parameter(Mandatory=$false)]
    [String]
    $64BitDownloadLocation = "http://winampplugins.co.uk/curl/curl_7_50_0_openssl_nghttp2_x64.7z"
)
